...
regex-rustgo/regex-rustgo.a: regex-rustgo/rustgo.go regex-rustgo/rustgo.o regex-rustgo/libed25519_dalek_rustgo.o
		go tool compile -N -l -o $@ -p main -pack regex-rustgo/rustgo.go
		go tool pack r $@ regex-rustgo/rustgo.o regex-rustgo/libed25519_dalek_rustgo.o

regex-rustgo/libed25519_dalek_rustgo.o: target/$(TARGET)/release/libed25519_dalek_rustgo.a
...
.PHONY: clean
clean:
		rm -rf regex-rustgo/*.[oa] target ed25519-dalek-rustgo
